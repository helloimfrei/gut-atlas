...
Performance: The XGBoost model achieved a cross-validation ROC AUC of 0.8394, representing strong predictive performance on this challenging task.
...
Performance: The LightGBM model achieved a cross-validation ROC AUC of 0.8340.
...
Logistic Regression (ElasticNet): CV ROC AUC 0.7796, Test ROC AUC 0.7775 (Highly interpretable coefficients)
XGBoost: CV ROC AUC 0.8394, Test ROC AUC 0.8353 (Best traditional ML performance)
LightGBM: CV ROC AUC 0.8340, Test ROC AUC 0.8277 (Efficient with sparse data)
Basic Neural Network: Not fully evaluated
DAE + Classifier: Test ROC AUC 0.6945 (5.1x feature compression)
...
3. Dimensionality Reduction: The denoising autoencoder successfully compressed 2,597 bacterial features into a 512-dimensional latent representation (5.1x compression). However, the DAE approach achieved lower predictive performance (ROC AUC: 0.6945) compared to traditional ML models, suggesting that either more aggressive compression loses critical information, or the simpler gradient boosting approaches are better suited to this particular dataset.
...
Streptococcus Species Abundance in the Gut Is Linked to Subclinical Coronary Atherosclerosis
