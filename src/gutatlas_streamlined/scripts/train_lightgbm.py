"""
Train LightGBM binary classifier for GI disease prediction.
"""
...
from models import LGBMBinClassTuner, ModelManager
...
def train_lightgbm(
    ...
    experiment_name: str = "gi_lightgbm",
    cv_splits: int = 5,
    n_iter: int = 10,
    n_jobs: int = -1,
    random_state: int = 42,
    ...
    """
    Train LightGBM model with Bayesian hyperparameter optimization.
